...
class StatusTest(unittest.TestCase):
	...
	def testApplyNonVolatileStatus(self):
		...
		check = pokemon.nonVolatileStatus.applyNonVolatileStatus(StatusType.Burned, pokemon)
		
		self.assertEqual(False, check)
		self.assertEqual(pokemon.nonVolatileStatus.type, StatusType.Normal)

		pokemon.nonVolatileStatus.applyNonVolatileStatus(StatusType.Asleep, pokemon)
